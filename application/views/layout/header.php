        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">BPF TI 
                <sup>2023</sup></span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            if ($user['role'] == 'Admin') { ?>
              ...
              <li class="menu-item">
                <a href="<?= site_url('Calon_presiden/'); ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-dock-top"></i>
                  <div>Calon Presiden</div>
                </a>
              </li>
          <?php } else { ?>
            <li class="menu-item">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?= base_url('assets/assets/img/avatars/') . $user['gambar']; ?>" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
